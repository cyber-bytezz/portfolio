    ...
    >
      <div ref={ref} id="contact" className="w-3/5 mx-auto p-8 mt-16">
        ...
        <div className="grid grid-cols-3 grid-rows-1 my-8 gap-12 lg:gap-0">
          <Link href="https://github.com/cyber-bytezz" target="_blank">
          ...
          <Link href="https://www.linkedin.com/in/-aro-barath-chandru--12725622a/?originalSubdomain=in" target="_blank">
            <div className="flex flex-col justify-center items-center hover:scale-110 transition-transform">
              <svg
                fill="#ffffff"
                viewBox="0 0 24 24"
          ...
          <Link href="mailto:chandru2021007@gmail.com">
            <div className="flex flex-col justify-center items-center hover:scale-110 transition-transform">
              <svg
                fill="#ffffff"
                viewBox="0 0 24 24"
