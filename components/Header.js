  ...
  return (
    <header className="container flex flex-row relative justify-between items-center px-4 py-2 lg:p-2 mt-4 z-[999]">
      ...
      {displayNav && (
        <>
          <motion.div
            className="hidden sm:block fixed top-3 left-1/2 h-[3.5rem] w-[24rem] rounded-full border border-neutral-800 border-opacity-80 bg-dark-alternative bg-opacity-50 shadow-lg shadow-[#1E90FF]/[0.08] backdrop-blur-[0.6rem]"
      ...
      >
        ...
        <a
          href="/Aro's Resume.pdf"
          alt="Aro's Resume"
          target="_blank"
          rel="noopener noreferrer"
          className="px-1 sm:px-2 py-1 h-fit no-underline font-roboto font-light bg-transparent border-[1px] border-[#1E90FF] text-[#1E90FF] hover:bg-[#1E90FF] hover:text-primary rounded-md"
        >
          Resume
        </a>
      </motion.div>
