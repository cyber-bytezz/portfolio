  ...
  return (
    <SectionCard>
      ...
      >
        ...
        <a
          href="/Aro_Barath_Chandru.pdf"
          alt="Aro's Resume"
          target="_blank"
          rel="noopener noreferrer"
          className="no-underline px-1 text-[#1E90FF] hover:bg-[#1E90FF] hover:text-primary transition-all"
        >
          resume
        </a>
      </motion.p>
            ...
            <ul className="flex flex-col lg:flex-row lg:flex-wrap">
              {tabsanddetails.map((tad) => (
                <li
                  key={tad.workrole}
                  className={clsx(
                    "text-primary py-3 px-5 sm:py-5 sm:px-6 rounded-xl sm:rounded-[20px] cursor-pointer relative",
                    tad === selectedTab && "bg-dark-secondary"
                  )}
          ...
          <div className="lg:w-[38em] bg-dark-alternative border-2 border-neutral-700 rounded-[20px] py-8 px-4">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start px-6">
                  <div className="flex flex-col items-center sm:flex-row gap-3">
                    ...
                    <div className="flex flex-col items-center sm:items-start text-primary">
                      <p className="font-roboto font-bold text-base sm:text-lg m-0 p-0">
                        {selectedTab.workrole}
                      </p>
                      <p className="font-roboto font-light text-base m-0 p-0">
                        {selectedTab.dates}
                      </p>
                      <p className="sm:hidden font-roboto text-base border-t-[1px] border-white mt-2 text-[#1E90FF]">
                  ...
                  <div className="hidden sm:flex flex-row py-2">
                    ...
                    <p className="font-roboto text-base text-[#1E90FF]">
                      {selectedTab.companyname}
                    </p>
                  </div>
                </div>
                ...
                <div className="my-4">
                  <ul className="pl-4 sm:pl-20 space-y-2 text-primary list-disc list-outside marker:text-[#1E90FF] marker:text-xl">
